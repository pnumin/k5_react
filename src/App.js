      ...
      <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            ...
            <Link to="/fe" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">FrontEnd</Link>
            <Link to="/lotto" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">Lotto</Link>
            <Link to="/box" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">박스오피스</Link>
